...
<?php $__env->startSection('form'); ?>
    <form action="<?php echo e(route('storeNewSong')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <div class="fs-5 my-5 ">
...
unset($__errorArgs, $__bag); ?>" type=text name="titolo" id="titolo">
...
unset($__errorArgs, $__bag); ?>" type=date name="pubblicazione" id="pubblicazione">
                    ...
                    <div class="form-row py-2" id="artista">
                        <select class="form-select" name="artisti[]" id="artisti-0"> 
                            ...
                            <?php $__currentLoopData = $singers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $singer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($singer->id); ?>"><?php echo e($singer->nome); ?></option>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $("#formSubmitButton").click(function(e){
                ...
                $.ajax({
                    type:'PUT',
                    url:"<?php echo e(route('storeNewSong')); ?>",
...
<?php echo $__env->make('layouts.fromCard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mau/Documents/laraveltest/laraveltest/laraveltestv2/resources/views/formNewSong.blade.php ENDPATH**/ ?>